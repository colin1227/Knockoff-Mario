...
const detWinner =() =>{
	if(player1T > player2T){
		$('html').html("Player 1 Wins! " + timer + "." + time2 + "s").css({ "font-size": "32px", "background-color": "green", "font-family": "Comic Sans" })
	}
	else if (player1T < player2T){
		$('html').html("Player 2 Wins! " + timer + "." + time2 + "s").css({ "font-size": "32px", "background-color": "green", "font-family": "Comic Sans" })
...
const startTimer = (playerTime) => {
	...
	if (block18.leftX <= 75) {
		...
		$('html').html("good job your time is " + timer + "."+ time2 + "s " + "player 2's turn!").css({ "font-size": "32px", "background-color": "green", "font-family": "Comic Sans" })
		 theVal = timer + "." + time2;
